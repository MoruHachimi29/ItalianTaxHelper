...
const importProductCategories = [
  { id: "electronics", name: "Elettronica di consumo", rate: 0.035 },
  { id: "computers", name: "Computer e accessori", rate: 0.03 },
  { id: "smartphones", name: "Smartphone e dispositivi mobili", rate: 0.04 },
  { id: "home_appliances", name: "Elettrodomestici", rate: 0.045 },
  { id: "clothing", name: "Abbigliamento", rate: 0.12 },
  { id: "footwear", name: "Calzature", rate: 0.10 },
  { id: "leather_goods", name: "Articoli in pelle", rate: 0.095 },
  { id: "textiles", name: "Prodotti tessili", rate: 0.08 },
  { id: "food", name: "Prodotti alimentari", rate: 0.055 },
  { id: "beverages", name: "Bevande", rate: 0.07 },
  { id: "dairy", name: "Prodotti lattiero-caseari", rate: 0.065 },
  { id: "fruits", name: "Frutta e verdura", rate: 0.035 },
  { id: "meat", name: "Carni e derivati", rate: 0.08 },
  { id: "cosmetics", name: "Cosmetici", rate: 0.065 },
  { id: "perfumes", name: "Profumi", rate: 0.095 },
  { id: "pharmaceuticals", name: "Prodotti farmaceutici", rate: 0.01 },
  { id: "medical_devices", name: "Dispositivi medici", rate: 0.02 },
  { id: "automobiles", name: "Automobili", rate: 0.10 },
  { id: "auto_parts", name: "Parti di automobili", rate: 0.07 },
  { id: "motorcycles", name: "Motocicli", rate: 0.075 },
  { id: "bicycles", name: "Biciclette", rate: 0.05 },
  { id: "furniture", name: "Mobili", rate: 0.045 },
  { id: "lighting", name: "Illuminazione", rate: 0.04 },
  { id: "kitchenware", name: "Articoli per la cucina", rate: 0.035 },
  { id: "jewelry", name: "Gioielli", rate: 0.07 },
  { id: "watches", name: "Orologi", rate: 0.08 },
  { id: "optical", name: "Prodotti ottici", rate: 0.05 },
  { id: "toys", name: "Giocattoli", rate: 0.055 },
  { id: "sports", name: "Articoli sportivi", rate: 0.045 },
  { id: "musical", name: "Strumenti musicali", rate: 0.03 },
  { id: "books", name: "Libri", rate: 0.00 },
  { id: "art", name: "Opere d'arte", rate: 0.00 },
  { id: "collectibles", name: "Oggetti da collezione", rate: 0.06 },
  { id: "chemicals", name: "Prodotti chimici", rate: 0.06 },
  { id: "plastics", name: "Prodotti in plastica", rate: 0.05 },
  { id: "ceramics", name: "Prodotti in ceramica", rate: 0.045 },
  { id: "glass", name: "Prodotti in vetro", rate: 0.055 },
  { id: "paper", name: "Prodotti in carta", rate: 0.03 },
...
const exportProductCategories = [
  ...
  { id: "industrial_tools", name: "Utensili industriali", rate: 0.01 },
  { id: "agricultural_machinery", name: "Macchinari agricoli", rate: 0.02 },
  { id: "printing_machinery", name: "Macchinari per stampa", rate: 0.015 },
  { id: "automotive", name: "Componenti automotive", rate: 0.02 },
  { id: "cars", name: "Automobili", rate: 0.04 },
  { id: "commercial_vehicles", name: "Veicoli commerciali", rate: 0.03 },
  { id: "vehicle_parts", name: "Parti di veicoli", rate: 0.025 },
  { id: "fashion", name: "Moda e accessori", rate: 0.01 },
  { id: "luxury_fashion", name: "Moda di lusso", rate: 0.015 },
  { id: "fashion_accessories", name: "Accessori moda", rate: 0.02 },
  { id: "shoes", name: "Calzature", rate: 0.025 },
  { id: "wine", name: "Vino e alcolici", rate: 0.05 },
  { id: "sparkling_wine", name: "Vini spumanti", rate: 0.06 },
  { id: "spirits", name: "Liquori", rate: 0.07 },
  { id: "craft_beer", name: "Birre artigianali", rate: 0.04 },
  { id: "food", name: "Prodotti alimentari", rate: 0.03 },
  { id: "olive_oil", name: "Olio d'oliva", rate: 0.025 },
  { id: "pasta", name: "Pasta", rate: 0.02 },
  { id: "cheese", name: "Formaggi", rate: 0.035 },
  { id: "canned_food", name: "Conserve alimentari", rate: 0.03 },
  { id: "coffee", name: "Caffè", rate: 0.04 },
  { id: "furniture", name: "Mobili e design", rate: 0.015 },
  { id: "lighting_fixtures", name: "Illuminazione design", rate: 0.02 },
  { id: "home_decor", name: "Articoli di arredamento", rate: 0.025 },
  { id: "office_furniture", name: "Mobili per ufficio", rate: 0.015 },
  { id: "pharmaceuticals", name: "Prodotti farmaceutici", rate: 0.00 },
  { id: "medical_equipment", name: "Attrezzature mediche", rate: 0.01 },
  { id: "diagnostic_equipment", name: "Apparecchiature diagnostiche", rate: 0.005 },
  { id: "cosmetics", name: "Cosmetici", rate: 0.025 },
  { id: "perfumes", name: "Profumi", rate: 0.035 },
  { id: "skincare", name: "Prodotti per la cura della pelle", rate: 0.03 },
  { id: "jewelry", name: "Gioielli e orologi", rate: 0.045 },
  { id: "footwear", name: "Calzature", rate: 0.03 },
  { id: "textiles", name: "Tessuti", rate: 0.02 },
  { id: "leather_goods", name: "Articoli in pelle", rate: 0.025 },
  { id: "technology", name: "Prodotti tecnologici", rate: 0.02 },
