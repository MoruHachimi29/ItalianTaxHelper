...
export default function NewsList({ limit = 3, showViewAllButton = true }: NewsListProps) {
  ...
  return (
    <section className="py-12 md:py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="font-serif text-2xl md:text-3xl font-bold mb-8 text-center">Ultime Notizie Economiche</h2>
