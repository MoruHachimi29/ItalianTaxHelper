...
const currencies = [
  ...
  { code: "SEK", name: "Corona svedese (SEK)" },
  { code: "NOK", name: "Corona norvegese (NOK)" },
  { code: "DKK", name: "Corona danese (DKK)" },
  { code: "PLN", name: "Zloty polacco (PLN)" },
  { code: "CZK", name: "Corona ceca (CZK)" },
  { code: "HUF", name: "Fiorino ungherese (HUF)" },
  { code: "RON", name: "Leu rumeno (RON)" },
  { code: "BGN", name: "Lev bulgaro (BGN)" },
  { code: "HRK", name: "Kuna croata (HRK)" },
  { code: "TRY", name: "Lira turca (TRY)" },
  { code: "RUB", name: "Rublo russo (RUB)" },
  { code: "INR", name: "Rupia indiana (INR)" },
  { code: "KRW", name: "Won sudcoreano (KRW)" },
  { code: "MXN", name: "Peso messicano (MXN)" },
  { code: "BRL", name: "Real brasiliano (BRL)" },
  { code: "SGD", name: "Dollaro di Singapore (SGD)" },
  { code: "HKD", name: "Dollaro di Hong Kong (HKD)" },
  { code: "NZD", name: "Dollaro neozelandese (NZD)" },
  { code: "ZAR", name: "Rand sudafricano (ZAR)" },
  { code: "AED", name: "Dirham degli Emirati Arabi (AED)" },
  { code: "SAR", name: "Riyal saudita (SAR)" },
  { code: "THB", name: "Baht tailandese (THB)" },
];
